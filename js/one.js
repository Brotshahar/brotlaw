...
form.addEventListener("submit",(e) => {
    e.preventDefault();
        ...
        result.innerHTML = `הטופס נשלח בהצלחה <i class="fa-solid fa-circle-dot" style="color: green ";></i>`;
        form.reset();
    ...
    function validateInputs (target){;
        if(target === "name"){
            ...
            else return nameError.innerHTML =  `<i class="fa-solid fa-circle-dot" style="color: green ";></i>` 
        }
        if(target === "email"){
            ...
            else return emailError.innerHTML =  `<i class="fa-solid fa-circle-dot" style="color: green ";></i>` 
        }
        if(target === "phone"){
            ...
            else return phoneError.innerHTML = `<i class="fa-solid fa-circle-dot" style="color: green ";></i>` 
        }
